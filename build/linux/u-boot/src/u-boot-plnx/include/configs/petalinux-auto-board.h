...
/* Features that not been implemented due to hw support */
	...
	#define	CONFIG_ENV_SECT_SIZE	0x20000	/* 128K(one sector) for env */
		...
		#define	CONFIG_ENV_ADDR		0x00500000
	...
	#define CONFIG_ENV_OFFSET	0x00500000
	#define CONFIG_ENV_SIZE	0x00020000
	#define CONFIG_ENV_SECT_SIZE	0x20000 /* 128K(one sector) for env */
...
#define MTDPARTS_DEFAULT	"mtdparts=0:5M(boot),128K(bootenv),10752K(image),0M(spare)"
#endif
...
#define	CONFIG_ETHADDR		00:0a:35:00:7b:e8
...
#define CONFIG_EXTRA_ENV_SETTINGS_COMMON \
	...
	"bootfile=image.ub\0" \
	"mtdids=nor0=0\0" \
	"mtdparts=mtdparts=0:5M(boot),128K(bootenv),10752K(image),0M(spare)\0" \
	CONSOLE_ARG \
	NETCONSOLE_ARG \
	SERIAL_MULTI \
	TTYUL0 \
	...
	"dtbnetstart=0x1a80000\0" \
	"loadaddr=0x1000000\0" \
	"bootsize=0x00500000\0" \
	"bootstart=0x00000000\0" \
	"bootenvsize=0x00020000\0" \
	"bootenvstart=0x00500000\0" \
	"confsize=\0" \
	"confstart=\0" \
	"jffs2size=\0" \
	"jffs2start=\0" \
	"kernsize=0x00a80000\0" \
	"kernstart=0x00520000\0" \
	"dtbsize=\0" \
	"dtbstart=\0" \
